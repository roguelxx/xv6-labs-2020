...
// Given a process's page table from_tbl, copy
// its PTE between [va_start, va_end) into a to_tbl page table.
void
uvmcopy2kernel(pagetable_t from_tbl, pagetable_t to_tbl, uint64 va_start, uint64 va_end)
{
